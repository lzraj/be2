...
import Boxes from './Components/boxes/Main';
...
import Home from './Components/all/Main';
    ...
    <DataContext.Provider value={{
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/boxes" element={<RequireAuth role="user"><Boxes /></RequireAuth>}></Route>
          <Route path="/containers" element={<RequireAuth role="user"><Containers /></RequireAuth>}></Route>
